...
struct Prompts {
    ...
    static var mealTagsPrompt: String {
        return "Only return the result: Give me a very short list on some tags you might give to the food. (High carb, low calory, etc...). Ensure the tags are comma-separated and concise."
    }
}
